...
const PDFrespostadiagnostico = () => {
    const { formularioId, respostaId, empresaId, diagnosticoId } = useParams();
    const [isAdmin, setIsAdmin] = useState(false);
    const [resposta, setResposta] = useState(null);
    const [formulario, setFormulario] = useState(null);
    const [medias, setMedias] = useState([]);

    console.log(formularioId, respostaId, empresaId, diagnosticoId);
    useEffect(() => {
...
export default PDFrespostadiagnostico;
